...
AXES_LOCKOUT_PARAMETERS = ["username"]  # Locks the specific account, NOT the whole WiFi network!
...
EMAIL_TIMEOUT = 10 # <-- NEW: Give up after 10 seconds to prevent crashes